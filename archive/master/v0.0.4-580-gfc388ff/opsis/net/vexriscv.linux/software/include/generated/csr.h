//--------------------------------------------------------------------------------
// Auto-generated by Migen (5585912) & LiteX (e637aa65) on 2019-08-04 04:57:55
//--------------------------------------------------------------------------------
...
/* cpu */
#define CSR_CPU_BASE 0x82000800L
#define CSR_CPU_TIMER_LATCH_ADDR 0x82000800L
...
static inline unsigned long long int cpu_timer_time_read(void) {
	...
	r <<= 8;
	r |= csr_readl(0x82000820L);
	return r;
}
#define CSR_CPU_TIMER_TIME_CMP_ADDR 0x82000824L
#define CSR_CPU_TIMER_TIME_CMP_SIZE 8
static inline unsigned long long int cpu_timer_time_cmp_read(void) {
	unsigned long long int r = csr_readl(0x82000824L);
	r <<= 8;
	r |= csr_readl(0x82000828L);
	r <<= 8;
	r |= csr_readl(0x8200082cL);
	r <<= 8;
	r |= csr_readl(0x82000830L);
	r <<= 8;
	r |= csr_readl(0x82000834L);
	r <<= 8;
	r |= csr_readl(0x82000838L);
	r <<= 8;
	r |= csr_readl(0x8200083cL);
	r <<= 8;
	r |= csr_readl(0x82000840L);
	return r;
}
static inline void cpu_timer_time_cmp_write(unsigned long long int value) {
	csr_writel(value >> 56, 0x82000824L);
	csr_writel(value >> 48, 0x82000828L);
	csr_writel(value >> 40, 0x8200082cL);
	csr_writel(value >> 32, 0x82000830L);
	csr_writel(value >> 24, 0x82000834L);
	csr_writel(value >> 16, 0x82000838L);
	csr_writel(value >> 8, 0x8200083cL);
	csr_writel(value, 0x82000840L);
}
