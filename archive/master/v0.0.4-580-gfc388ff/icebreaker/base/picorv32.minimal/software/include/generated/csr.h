...
#define CSR_CAS_BUTTONS_EV_ENABLE_ADDR 0x8200080cL
...
/* rgbled */
#define CSR_RGBLED_BASE 0x82004000L
#define CSR_RGBLED_DAT_ADDR 0x82004000L
#define CSR_RGBLED_DAT_SIZE 1
static inline unsigned char rgbled_dat_read(void) {
	unsigned char r = csr_readl(0x82004000L);
	return r;
}
static inline void rgbled_dat_write(unsigned char value) {
	csr_writel(value, 0x82004000L);
}
#define CSR_RGBLED_ADDR_ADDR 0x82004004L
#define CSR_RGBLED_ADDR_SIZE 1
static inline unsigned char rgbled_addr_read(void) {
	unsigned char r = csr_readl(0x82004004L);
	return r;
}
static inline void rgbled_addr_write(unsigned char value) {
	csr_writel(value, 0x82004004L);
}
#define CSR_RGBLED_CTRL_ADDR 0x82004008L
#define CSR_RGBLED_CTRL_SIZE 1
static inline unsigned char rgbled_ctrl_read(void) {
	unsigned char r = csr_readl(0x82004008L);
	return r;
}
static inline void rgbled_ctrl_write(unsigned char value) {
