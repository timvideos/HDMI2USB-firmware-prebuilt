//--------------------------------------------------------------------------------
// Auto-generated by Migen (5585912) & LiteX (e637aa65) on 2019-08-04 02:58:55
//--------------------------------------------------------------------------------
module top(
	input serial_rx,
...
wire csrbankarray_csrbank0_switches_in_re;
wire [3:0] csrbankarray_csrbank0_switches_in_r;
wire [3:0] csrbankarray_csrbank0_switches_in_w;
...
assign csrbankarray_csrbank0_switches_in_r = csrbankarray_interface0_bank_bus_dat_w[3:0];
assign csrbankarray_csrbank0_switches_in_re = ((csrbankarray_csrbank0_sel & csrbankarray_interface0_bank_bus_we) & (csrbankarray_interface0_bank_bus_adr[0] == 1'd1));
assign cas_leds_storage = cas_leds_storage_full[2:0];
assign csrbankarray_csrbank0_leds_out0_w = cas_leds_storage_full[2:0];
assign csrbankarray_csrbank0_switches_in_w = cas_switches_status[3:0];
...
always @(posedge sys_clk) begin
	...
	if (csrbankarray_csrbank0_sel) begin
		case (csrbankarray_interface0_bank_bus_adr[0])
			...
			1'd1: begin
				csrbankarray_interface0_bank_bus_dat_r <= csrbankarray_csrbank0_switches_in_w;
			end
		endcase
	end
	if (csrbankarray_csrbank0_leds_out0_re) begin
		cas_leds_storage_full[2:0] <= csrbankarray_csrbank0_leds_out0_r;
	end
