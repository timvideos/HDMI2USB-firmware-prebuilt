...
/* encoder_reader */
#define CSR_ENCODER_READER_BASE 0xe000a000
#define CSR_ENCODER_READER_BASE_ADDR 0xe000a000
#define CSR_ENCODER_READER_BASE_SIZE 4
static inline unsigned int encoder_reader_base_read(void) {
	unsigned int r = MMPTR(0xe000a000);
	r <<= 8;
	r |= MMPTR(0xe000a004);
	r <<= 8;
	r |= MMPTR(0xe000a008);
...
#define CSR_ENCODER_READER_DONE_ADDR 0xe000a024
