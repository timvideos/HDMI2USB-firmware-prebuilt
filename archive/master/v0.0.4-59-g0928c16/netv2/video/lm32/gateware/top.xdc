...
create_clock -name pix_clk -period 10.0 [get_nets pix_clk]

set_false_path -from [get_clocks sys_clk] -to [get_clocks pix_clk]

set_false_path -from [get_clocks pix_clk] -to [get_clocks sys_clk]

set_false_path -quiet -through [get_nets -hier -filter {ars_false_path==true}] -to [get_cells -hier -filter {ars_ff==true}]

set_max_delay 2 -quiet -from [get_cells -hier -filter {ars_ff==true}] -to [get_cells -hier -filter {ars_ff==true}]