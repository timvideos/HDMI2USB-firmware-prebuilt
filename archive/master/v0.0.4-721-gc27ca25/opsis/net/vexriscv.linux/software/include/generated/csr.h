...
/* front_panel */
#define CSR_FRONT_PANEL_BASE 0xf0005800L
#define CSR_FRONT_PANEL_SWITCHES_IN_ADDR 0xf0005800L
...
#define CSR_FRONT_PANEL_LEDS_OUT_ADDR 0xf0005804L
...
/* info */
#define CSR_INFO_BASE 0xf0006800L
#define CSR_INFO_DNA_ID_ADDR 0xf0006800L
#define CSR_INFO_DNA_ID_SIZE 8
static inline unsigned long long int info_dna_id_read(void) {
	unsigned long long int r = csr_readl(0xf0006800L);
	r <<= 8;
	r |= csr_readl(0xf0006804L);
	r <<= 8;
...
#define CSR_INFO_GIT_COMMIT_ADDR 0xf0006820L
#define CSR_INFO_GIT_COMMIT_SIZE 20
#define CSR_INFO_PLATFORM_PLATFORM_ADDR 0xf0006870L
#define CSR_INFO_PLATFORM_PLATFORM_SIZE 8
static inline unsigned long long int info_platform_platform_read(void) {
	unsigned long long int r = csr_readl(0xf0006870L);
	r <<= 8;
	r |= csr_readl(0xf0006874L);
	r <<= 8;
	r |= csr_readl(0xf0006878L);
	r <<= 8;
	r |= csr_readl(0xf000687cL);
	r <<= 8;
	r |= csr_readl(0xf0006880L);
	r <<= 8;
	r |= csr_readl(0xf0006884L);
	r <<= 8;
	r |= csr_readl(0xf0006888L);
	r <<= 8;
	r |= csr_readl(0xf000688cL);
	return r;
}
#define CSR_INFO_PLATFORM_TARGET_ADDR 0xf0006890L
#define CSR_INFO_PLATFORM_TARGET_SIZE 8
static inline unsigned long long int info_platform_target_read(void) {
	unsigned long long int r = csr_readl(0xf0006890L);
	r <<= 8;
	r |= csr_readl(0xf0006894L);
	r <<= 8;
	r |= csr_readl(0xf0006898L);
	r <<= 8;
	r |= csr_readl(0xf000689cL);
	r <<= 8;
	r |= csr_readl(0xf00068a0L);
	r <<= 8;
	r |= csr_readl(0xf00068a4L);
	r <<= 8;
	r |= csr_readl(0xf00068a8L);
	r <<= 8;
	r |= csr_readl(0xf00068acL);
	return r;
}

/* opsis_i2c */
#define CSR_OPSIS_I2C_BASE 0xf0008800L
#define CSR_OPSIS_I2C_MASTER_W_ADDR 0xf0008800L
...
#define CSR_OPSIS_I2C_MASTER_R_ADDR 0xf0008804L
...
/* uart */
#define CSR_UART_BASE 0xf0009000L
#define CSR_UART_RXTX_ADDR 0xf0009000L
#define CSR_UART_RXTX_SIZE 1
static inline unsigned char uart_rxtx_read(void) {
	unsigned char r = csr_readl(0xf0009000L);
	return r;
}
static inline void uart_rxtx_write(unsigned char value) {
	csr_writel(value, 0xf0009000L);
}
#define CSR_UART_TXFULL_ADDR 0xf0009004L
#define CSR_UART_TXFULL_SIZE 1
static inline unsigned char uart_txfull_read(void) {
	unsigned char r = csr_readl(0xf0009004L);
	return r;
}
#define CSR_UART_RXEMPTY_ADDR 0xf0009008L
#define CSR_UART_RXEMPTY_SIZE 1
static inline unsigned char uart_rxempty_read(void) {
	unsigned char r = csr_readl(0xf0009008L);
	return r;
}
#define CSR_UART_EV_STATUS_ADDR 0xf000900cL
#define CSR_UART_EV_STATUS_SIZE 1
static inline unsigned char uart_ev_status_read(void) {
	unsigned char r = csr_readl(0xf000900cL);
	return r;
}
static inline void uart_ev_status_write(unsigned char value) {
	csr_writel(value, 0xf000900cL);
}
#define CSR_UART_EV_PENDING_ADDR 0xf0009010L
#define CSR_UART_EV_PENDING_SIZE 1
static inline unsigned char uart_ev_pending_read(void) {
	unsigned char r = csr_readl(0xf0009010L);
	return r;
}
static inline void uart_ev_pending_write(unsigned char value) {
	csr_writel(value, 0xf0009010L);
}
#define CSR_UART_EV_ENABLE_ADDR 0xf0009014L
#define CSR_UART_EV_ENABLE_SIZE 1
static inline unsigned char uart_ev_enable_read(void) {
	unsigned char r = csr_readl(0xf0009014L);
	return r;
}
static inline void uart_ev_enable_write(unsigned char value) {
	csr_writel(value, 0xf0009014L);
}

/* identifier_mem */
#define CSR_IDENTIFIER_MEM_BASE 0xf0001000L
