...
/* info */
#define CSR_INFO_BASE 0xe0000800L
#define CSR_INFO_DNA_ID_ADDR 0xe0000800L
#define CSR_INFO_DNA_ID_SIZE 8
static inline unsigned long long int info_dna_id_read(void) {
	unsigned long long int r = csr_readl(0xe0000800L);
	r <<= 8;
	r |= csr_readl(0xe0000804L);
	r <<= 8;
	r |= csr_readl(0xe0000808L);
	r <<= 8;
	r |= csr_readl(0xe000080cL);
	r <<= 8;
	r |= csr_readl(0xe0000810L);
	r <<= 8;
	r |= csr_readl(0xe0000814L);
	r <<= 8;
	r |= csr_readl(0xe0000818L);
	r <<= 8;
	r |= csr_readl(0xe000081cL);
	return r;
}
#define CSR_INFO_GIT_COMMIT_ADDR 0xe0000820L
#define CSR_INFO_GIT_COMMIT_SIZE 20
#define CSR_INFO_PLATFORM_PLATFORM_ADDR 0xe0000870L
#define CSR_INFO_PLATFORM_PLATFORM_SIZE 8
static inline unsigned long long int info_platform_platform_read(void) {
	unsigned long long int r = csr_readl(0xe0000870L);
	r <<= 8;
	r |= csr_readl(0xe0000874L);
	r <<= 8;
	r |= csr_readl(0xe0000878L);
	r <<= 8;
	r |= csr_readl(0xe000087cL);
	r <<= 8;
	r |= csr_readl(0xe0000880L);
	r <<= 8;
	r |= csr_readl(0xe0000884L);
	r <<= 8;
	r |= csr_readl(0xe0000888L);
	r <<= 8;
	r |= csr_readl(0xe000088cL);
	return r;
}
#define CSR_INFO_PLATFORM_TARGET_ADDR 0xe0000890L
#define CSR_INFO_PLATFORM_TARGET_SIZE 8
static inline unsigned long long int info_platform_target_read(void) {
	unsigned long long int r = csr_readl(0xe0000890L);
	r <<= 8;
	r |= csr_readl(0xe0000894L);
	r <<= 8;
	r |= csr_readl(0xe0000898L);
	r <<= 8;
	r |= csr_readl(0xe000089cL);
	r <<= 8;
	r |= csr_readl(0xe00008a0L);
	r <<= 8;
	r |= csr_readl(0xe00008a4L);
	r <<= 8;
	r |= csr_readl(0xe00008a8L);
	r <<= 8;
	r |= csr_readl(0xe00008acL);
	return r;
}
#define CSR_INFO_XADC_TEMPERATURE_ADDR 0xe00008b0L
#define CSR_INFO_XADC_TEMPERATURE_SIZE 2
static inline unsigned short int info_xadc_temperature_read(void) {
	unsigned short int r = csr_readl(0xe00008b0L);
	r <<= 8;
	r |= csr_readl(0xe00008b4L);
	return r;
}
#define CSR_INFO_XADC_VCCINT_ADDR 0xe00008b8L
#define CSR_INFO_XADC_VCCINT_SIZE 2
static inline unsigned short int info_xadc_vccint_read(void) {
	unsigned short int r = csr_readl(0xe00008b8L);
	r <<= 8;
	r |= csr_readl(0xe00008bcL);
	return r;
}
#define CSR_INFO_XADC_VCCAUX_ADDR 0xe00008c0L
#define CSR_INFO_XADC_VCCAUX_SIZE 2
static inline unsigned short int info_xadc_vccaux_read(void) {
	unsigned short int r = csr_readl(0xe00008c0L);
	r <<= 8;
	r |= csr_readl(0xe00008c4L);
	return r;
}
#define CSR_INFO_XADC_VCCBRAM_ADDR 0xe00008c8L
#define CSR_INFO_XADC_VCCBRAM_SIZE 2
static inline unsigned short int info_xadc_vccbram_read(void) {
	unsigned short int r = csr_readl(0xe00008c8L);
	r <<= 8;
	r |= csr_readl(0xe00008ccL);
	return r;
}
