...
#define sdram_dfii_pird_address_write(X) sdram_dfii_pi2_address_write(X)
#define sdram_dfii_piwr_address_write(X) sdram_dfii_pi3_address_write(X)
#define sdram_dfii_pird_baddress_write(X) sdram_dfii_pi2_baddress_write(X)
#define sdram_dfii_piwr_baddress_write(X) sdram_dfii_pi3_baddress_write(X)
#define command_prd(X) command_p2(X)
