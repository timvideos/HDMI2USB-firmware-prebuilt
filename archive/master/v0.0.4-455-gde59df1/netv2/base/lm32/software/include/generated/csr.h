...
static inline unsigned short int info_xadc_vccint_read(void) {
	unsigned short int r = csr_readl(0xe00068b8);
	r <<= 8;
	r |= csr_readl(0xe00068bc);
	return r;
}
...
static inline unsigned short int info_xadc_vccaux_read(void) {
	unsigned short int r = csr_readl(0xe00068c0);
	r <<= 8;
	r |= csr_readl(0xe00068c4);
	return r;
}
...
static inline unsigned short int info_xadc_vccbram_read(void) {
	unsigned short int r = csr_readl(0xe00068c8);
	r <<= 8;
	r |= csr_readl(0xe00068cc);
	return r;
}
...
static inline unsigned long long int sdram_dfii_pi0_wrdata_read(void) {
	unsigned long long int r = csr_readl(0xe0004018);
	r <<= 8;
...
static inline void sdram_dfii_pi0_wrdata_write(unsigned long long int value) {
	csr_writel(value >> 56, 0xe0004018);
	csr_writel(value >> 48, 0xe000401c);
	csr_writel(value >> 40, 0xe0004020);
	csr_writel(value >> 32, 0xe0004024);
	csr_writel(value >> 24, 0xe0004028);
	csr_writel(value >> 16, 0xe000402c);
	csr_writel(value >> 8, 0xe0004030);
...
static inline unsigned long long int sdram_dfii_pi0_rddata_read(void) {
	unsigned long long int r = csr_readl(0xe0004038);
	r <<= 8;
	r |= csr_readl(0xe000403c);
	r <<= 8;
	r |= csr_readl(0xe0004040);
	r <<= 8;
	r |= csr_readl(0xe0004044);
	r <<= 8;
	r |= csr_readl(0xe0004048);
	r <<= 8;
	r |= csr_readl(0xe000404c);
	r <<= 8;
...
static inline unsigned char sdram_dfii_pi1_command_read(void) {
	unsigned char r = csr_readl(0xe0004058);
	return r;
}
...
static inline unsigned char sdram_dfii_pi1_command_issue_read(void) {
	unsigned char r = csr_readl(0xe000405c);
	return r;
}
...
static inline unsigned long long int sdram_dfii_pi1_wrdata_read(void) {
	unsigned long long int r = csr_readl(0xe000406c);
	r <<= 8;
	r |= csr_readl(0xe0004070);
	r <<= 8;
	r |= csr_readl(0xe0004074);
	r <<= 8;
	r |= csr_readl(0xe0004078);
	r <<= 8;
	r |= csr_readl(0xe000407c);
	r <<= 8;
...
static inline void sdram_dfii_pi1_wrdata_write(unsigned long long int value) {
	csr_writel(value >> 56, 0xe000406c);
	csr_writel(value >> 48, 0xe0004070);
	csr_writel(value >> 40, 0xe0004074);
	csr_writel(value >> 32, 0xe0004078);
	csr_writel(value >> 24, 0xe000407c);
	csr_writel(value >> 16, 0xe0004080);
	csr_writel(value >> 8, 0xe0004084);
	csr_writel(value, 0xe0004088);
}
...
static inline unsigned long long int sdram_dfii_pi1_rddata_read(void) {
	unsigned long long int r = csr_readl(0xe000408c);
	r <<= 8;
	r |= csr_readl(0xe0004090);
	r <<= 8;
	...
	r <<= 8;
	r |= csr_readl(0xe00040a0);
	r <<= 8;
	r |= csr_readl(0xe00040a4);
	r <<= 8;
	r |= csr_readl(0xe00040a8);
	return r;
}
...
static inline unsigned char sdram_dfii_pi2_command_read(void) {
	unsigned char r = csr_readl(0xe00040ac);
	return r;
}
...
static inline unsigned short int sdram_dfii_pi2_address_read(void) {
	unsigned short int r = csr_readl(0xe00040b4);
	r <<= 8;
	r |= csr_readl(0xe00040b8);
	return r;
}
static inline void sdram_dfii_pi2_address_write(unsigned short int value) {
	csr_writel(value >> 8, 0xe00040b4);
	csr_writel(value, 0xe00040b8);
}
...
static inline unsigned long long int sdram_dfii_pi2_wrdata_read(void) {
	unsigned long long int r = csr_readl(0xe00040c0);
	r <<= 8;
	r |= csr_readl(0xe00040c4);
	r <<= 8;
	...
	r <<= 8;
	r |= csr_readl(0xe00040d4);
	r <<= 8;
	r |= csr_readl(0xe00040d8);
	r <<= 8;
	r |= csr_readl(0xe00040dc);
	return r;
}
static inline void sdram_dfii_pi2_wrdata_write(unsigned long long int value) {
	csr_writel(value >> 56, 0xe00040c0);
	csr_writel(value >> 48, 0xe00040c4);
	csr_writel(value >> 40, 0xe00040c8);
	csr_writel(value >> 32, 0xe00040cc);
	csr_writel(value >> 24, 0xe00040d0);
	csr_writel(value >> 16, 0xe00040d4);
	csr_writel(value >> 8, 0xe00040d8);
	csr_writel(value, 0xe00040dc);
}
...
static inline unsigned long long int sdram_dfii_pi2_rddata_read(void) {
	unsigned long long int r = csr_readl(0xe00040e0);
	r <<= 8;
	r |= csr_readl(0xe00040e4);
	r <<= 8;
	r |= csr_readl(0xe00040e8);
	r <<= 8;
	r |= csr_readl(0xe00040ec);
	r <<= 8;
	r |= csr_readl(0xe00040f0);
	r <<= 8;
	r |= csr_readl(0xe00040f4);
	r <<= 8;
	r |= csr_readl(0xe00040f8);
	r <<= 8;
	r |= csr_readl(0xe00040fc);
	return r;
}
...
static inline unsigned short int sdram_dfii_pi3_address_read(void) {
	unsigned short int r = csr_readl(0xe0004108);
	r <<= 8;
	r |= csr_readl(0xe000410c);
	return r;
}
static inline void sdram_dfii_pi3_address_write(unsigned short int value) {
	csr_writel(value >> 8, 0xe0004108);
	csr_writel(value, 0xe000410c);
}
...
static inline unsigned long long int sdram_dfii_pi3_wrdata_read(void) {
	unsigned long long int r = csr_readl(0xe0004114);
	r <<= 8;
	r |= csr_readl(0xe0004118);
	r <<= 8;
	r |= csr_readl(0xe000411c);
	r <<= 8;
	r |= csr_readl(0xe0004120);
	r <<= 8;
	r |= csr_readl(0xe0004124);
	r <<= 8;
	r |= csr_readl(0xe0004128);
	r <<= 8;
	r |= csr_readl(0xe000412c);
	r <<= 8;
	r |= csr_readl(0xe0004130);
	return r;
}
static inline void sdram_dfii_pi3_wrdata_write(unsigned long long int value) {
	csr_writel(value >> 56, 0xe0004114);
	csr_writel(value >> 48, 0xe0004118);
	csr_writel(value >> 40, 0xe000411c);
	csr_writel(value >> 32, 0xe0004120);
	csr_writel(value >> 24, 0xe0004124);
	csr_writel(value >> 16, 0xe0004128);
	csr_writel(value >> 8, 0xe000412c);
	csr_writel(value, 0xe0004130);
}
...
static inline unsigned long long int sdram_dfii_pi3_rddata_read(void) {
	unsigned long long int r = csr_readl(0xe0004134);
	r <<= 8;
	r |= csr_readl(0xe0004138);
	r <<= 8;
	r |= csr_readl(0xe000413c);
	r <<= 8;
	r |= csr_readl(0xe0004140);
	r <<= 8;
	r |= csr_readl(0xe0004144);
	r <<= 8;
	r |= csr_readl(0xe0004148);
	r <<= 8;
	r |= csr_readl(0xe000414c);
	r <<= 8;
	r |= csr_readl(0xe0004150);
	return r;
}
...
static inline unsigned int sdram_controller_bandwidth_nreads_read(void) {
	unsigned int r = csr_readl(0xe0004158);
	r <<= 8;
	r |= csr_readl(0xe000415c);
	r <<= 8;
	r |= csr_readl(0xe0004160);
	return r;
}
...
static inline unsigned int sdram_controller_bandwidth_nwrites_read(void) {
	unsigned int r = csr_readl(0xe0004164);
	r <<= 8;
	r |= csr_readl(0xe0004168);
	r <<= 8;
	r |= csr_readl(0xe000416c);
	return r;
}
...
static inline unsigned short int sdram_controller_bandwidth_data_width_read(void) {
	unsigned short int r = csr_readl(0xe0004170);
	r <<= 8;
	r |= csr_readl(0xe0004174);
	return r;
}
