//--------------------------------------------------------------------------------
// Auto-generated by Migen (5585912) & LiteX (e637aa65) on 2019-08-02 11:54:22
//--------------------------------------------------------------------------------
module top(
	input serial_rx,
...
always @(*) begin
	...
	slave_sel[2] <= (shared_adr[28:20] == 8'd128);
end
...
assign csrbankarray_csrbank0_leds_out0_w = cas_leds_storage_full[7:0];
...
always @(posedge sys_clk) begin
	...
	if (csrbankarray_csrbank0_leds_out0_re) begin
		cas_leds_storage_full[7:0] <= csrbankarray_csrbank0_leds_out0_r;
	end
...
VexRiscv VexRiscv(
	...
	.externalResetVector(30'd537034752),
