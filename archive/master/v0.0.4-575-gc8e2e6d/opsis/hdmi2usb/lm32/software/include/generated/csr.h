//--------------------------------------------------------------------------------
// Auto-generated by Migen (5585912) & LiteX (e637aa65) on 2019-08-02 13:19:09
//--------------------------------------------------------------------------------
...
/* encoder_reader */
#define CSR_ENCODER_READER_BASE 0x8200e800L
#define CSR_ENCODER_READER_BASE_ADDR 0x8200e800L
#define CSR_ENCODER_READER_BASE_SIZE 4
static inline unsigned int encoder_reader_base_read(void) {
	unsigned int r = csr_readl(0x8200e800L);
	r <<= 8;
	r |= csr_readl(0x8200e804L);
	r <<= 8;
	r |= csr_readl(0x8200e808L);
	r <<= 8;
	r |= csr_readl(0x8200e80cL);
	return r;
}
static inline void encoder_reader_base_write(unsigned int value) {
	csr_writel(value >> 24, 0x8200e800L);
	csr_writel(value >> 16, 0x8200e804L);
	csr_writel(value >> 8, 0x8200e808L);
	csr_writel(value, 0x8200e80cL);
}
#define CSR_ENCODER_READER_H_WIDTH_ADDR 0x8200e810L
#define CSR_ENCODER_READER_H_WIDTH_SIZE 2
static inline unsigned short int encoder_reader_h_width_read(void) {
	unsigned short int r = csr_readl(0x8200e810L);
	r <<= 8;
	r |= csr_readl(0x8200e814L);
	return r;
}
static inline void encoder_reader_h_width_write(unsigned short int value) {
	csr_writel(value >> 8, 0x8200e810L);
	csr_writel(value, 0x8200e814L);
}
#define CSR_ENCODER_READER_V_WIDTH_ADDR 0x8200e818L
#define CSR_ENCODER_READER_V_WIDTH_SIZE 2
static inline unsigned short int encoder_reader_v_width_read(void) {
	unsigned short int r = csr_readl(0x8200e818L);
	r <<= 8;
	r |= csr_readl(0x8200e81cL);
	return r;
}
static inline void encoder_reader_v_width_write(unsigned short int value) {
	csr_writel(value >> 8, 0x8200e818L);
	csr_writel(value, 0x8200e81cL);
}
#define CSR_ENCODER_READER_START_ADDR 0x8200e820L
#define CSR_ENCODER_READER_START_SIZE 1
static inline unsigned char encoder_reader_start_read(void) {
	unsigned char r = csr_readl(0x8200e820L);
	return r;
}
static inline void encoder_reader_start_write(unsigned char value) {
	csr_writel(value, 0x8200e820L);
}
#define CSR_ENCODER_READER_DONE_ADDR 0x8200e824L
#define CSR_ENCODER_READER_DONE_SIZE 1
static inline unsigned char encoder_reader_done_read(void) {
	unsigned char r = csr_readl(0x8200e824L);
	return r;
}
