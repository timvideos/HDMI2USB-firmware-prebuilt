//--------------------------------------------------------------------------------
// Auto-generated by Migen (5585912) & LiteX (e637aa65) on 2019-08-02 09:52:10
//--------------------------------------------------------------------------------
...
/* info */
#define CSR_INFO_BASE 0x82000800L
#define CSR_INFO_DNA_ID_ADDR 0x82000800L
#define CSR_INFO_DNA_ID_SIZE 8
static inline unsigned long long int info_dna_id_read(void) {
	unsigned long long int r = csr_readl(0x82000800L);
	r <<= 8;
	r |= csr_readl(0x82000804L);
	r <<= 8;
	r |= csr_readl(0x82000808L);
	r <<= 8;
	r |= csr_readl(0x8200080cL);
	r <<= 8;
	r |= csr_readl(0x82000810L);
	r <<= 8;
	r |= csr_readl(0x82000814L);
	r <<= 8;
	r |= csr_readl(0x82000818L);
	r <<= 8;
	r |= csr_readl(0x8200081cL);
	return r;
}
#define CSR_INFO_GIT_COMMIT_ADDR 0x82000820L
#define CSR_INFO_GIT_COMMIT_SIZE 20
#define CSR_INFO_PLATFORM_PLATFORM_ADDR 0x82000870L
#define CSR_INFO_PLATFORM_PLATFORM_SIZE 8
static inline unsigned long long int info_platform_platform_read(void) {
	unsigned long long int r = csr_readl(0x82000870L);
	r <<= 8;
	r |= csr_readl(0x82000874L);
	r <<= 8;
	r |= csr_readl(0x82000878L);
	r <<= 8;
	r |= csr_readl(0x8200087cL);
	r <<= 8;
	r |= csr_readl(0x82000880L);
	r <<= 8;
	r |= csr_readl(0x82000884L);
	r <<= 8;
	r |= csr_readl(0x82000888L);
	r <<= 8;
	r |= csr_readl(0x8200088cL);
	return r;
}
#define CSR_INFO_PLATFORM_TARGET_ADDR 0x82000890L
#define CSR_INFO_PLATFORM_TARGET_SIZE 8
static inline unsigned long long int info_platform_target_read(void) {
	unsigned long long int r = csr_readl(0x82000890L);
	r <<= 8;
	r |= csr_readl(0x82000894L);
	r <<= 8;
	r |= csr_readl(0x82000898L);
	r <<= 8;
	r |= csr_readl(0x8200089cL);
	r <<= 8;
	r |= csr_readl(0x820008a0L);
	r <<= 8;
	r |= csr_readl(0x820008a4L);
	r <<= 8;
	r |= csr_readl(0x820008a8L);
	r <<= 8;
	r |= csr_readl(0x820008acL);
	return r;
}
#define CSR_INFO_XADC_TEMPERATURE_ADDR 0x820008b0L
#define CSR_INFO_XADC_TEMPERATURE_SIZE 2
static inline unsigned short int info_xadc_temperature_read(void) {
	unsigned short int r = csr_readl(0x820008b0L);
	r <<= 8;
	r |= csr_readl(0x820008b4L);
	return r;
}
#define CSR_INFO_XADC_VCCINT_ADDR 0x820008b8L
#define CSR_INFO_XADC_VCCINT_SIZE 2
static inline unsigned short int info_xadc_vccint_read(void) {
	unsigned short int r = csr_readl(0x820008b8L);
	r <<= 8;
	r |= csr_readl(0x820008bcL);
	return r;
}
#define CSR_INFO_XADC_VCCAUX_ADDR 0x820008c0L
#define CSR_INFO_XADC_VCCAUX_SIZE 2
static inline unsigned short int info_xadc_vccaux_read(void) {
	unsigned short int r = csr_readl(0x820008c0L);
	r <<= 8;
	r |= csr_readl(0x820008c4L);
	return r;
}
#define CSR_INFO_XADC_VCCBRAM_ADDR 0x820008c8L
#define CSR_INFO_XADC_VCCBRAM_SIZE 2
static inline unsigned short int info_xadc_vccbram_read(void) {
	unsigned short int r = csr_readl(0x820008c8L);
	r <<= 8;
	r |= csr_readl(0x820008ccL);
	return r;
}
