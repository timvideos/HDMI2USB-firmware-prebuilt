...
static inline unsigned char ethmac_preamble_crc_read(void) {
	unsigned char r = MMPTR(0xe0007854);
	return r;
}
...
static inline unsigned int ethmac_preamble_errors_read(void) {
	unsigned int r = MMPTR(0xe0007858);
	r <<= 8;
	r |= MMPTR(0xe000785c);
	r <<= 8;
	r |= MMPTR(0xe0007860);
...
static inline unsigned int ethmac_crc_errors_read(void) {
	unsigned int r = MMPTR(0xe0007868);
	r <<= 8;
	r |= MMPTR(0xe000786c);
	r <<= 8;
	r |= MMPTR(0xe0007870);
