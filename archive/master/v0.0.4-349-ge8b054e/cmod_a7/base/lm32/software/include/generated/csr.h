...
/* info */
#define CSR_INFO_BASE 0xe0004800
#define CSR_INFO_DNA_ID_ADDR 0xe0004800
#define CSR_INFO_DNA_ID_SIZE 8
static inline unsigned long long int info_dna_id_read(void) {
	unsigned long long int r = csr_readl(0xe0004800);
	r <<= 8;
...
#define CSR_INFO_GIT_COMMIT_ADDR 0xe0004820
#define CSR_INFO_GIT_COMMIT_SIZE 20
#define CSR_INFO_PLATFORM_PLATFORM_ADDR 0xe0004870
#define CSR_INFO_PLATFORM_PLATFORM_SIZE 8
static inline unsigned long long int info_platform_platform_read(void) {
	unsigned long long int r = csr_readl(0xe0004870);
	r <<= 8;
	r |= csr_readl(0xe0004874);
	r <<= 8;
	r |= csr_readl(0xe0004878);
	r <<= 8;
	r |= csr_readl(0xe000487c);
	r <<= 8;
	r |= csr_readl(0xe0004880);
	r <<= 8;
	r |= csr_readl(0xe0004884);
	r <<= 8;
	r |= csr_readl(0xe0004888);
	r <<= 8;
	r |= csr_readl(0xe000488c);
	return r;
}
#define CSR_INFO_PLATFORM_TARGET_ADDR 0xe0004890
#define CSR_INFO_PLATFORM_TARGET_SIZE 8
static inline unsigned long long int info_platform_target_read(void) {
	unsigned long long int r = csr_readl(0xe0004890);
	r <<= 8;
	r |= csr_readl(0xe0004894);
	r <<= 8;
	r |= csr_readl(0xe0004898);
	r <<= 8;
	r |= csr_readl(0xe000489c);
	r <<= 8;
	r |= csr_readl(0xe00048a0);
	r <<= 8;
	r |= csr_readl(0xe00048a4);
	r <<= 8;
	r |= csr_readl(0xe00048a8);
	r <<= 8;
	r |= csr_readl(0xe00048ac);
	return r;
}
#define CSR_INFO_XADC_TEMPERATURE_ADDR 0xe00048b0
#define CSR_INFO_XADC_TEMPERATURE_SIZE 2
static inline unsigned short int info_xadc_temperature_read(void) {
	unsigned short int r = csr_readl(0xe00048b0);
	r <<= 8;
	r |= csr_readl(0xe00048b4);
	return r;
}
#define CSR_INFO_XADC_VCCINT_ADDR 0xe00048b8
#define CSR_INFO_XADC_VCCINT_SIZE 2
static inline unsigned short int info_xadc_vccint_read(void) {
	unsigned short int r = csr_readl(0xe00048b8);
	r <<= 8;
	r |= csr_readl(0xe00048bc);
	return r;
}
#define CSR_INFO_XADC_VCCAUX_ADDR 0xe00048c0
#define CSR_INFO_XADC_VCCAUX_SIZE 2
static inline unsigned short int info_xadc_vccaux_read(void) {
	unsigned short int r = csr_readl(0xe00048c0);
	r <<= 8;
	r |= csr_readl(0xe00048c4);
	return r;
}
#define CSR_INFO_XADC_VCCBRAM_ADDR 0xe00048c8
#define CSR_INFO_XADC_VCCBRAM_SIZE 2
static inline unsigned short int info_xadc_vccbram_read(void) {
	unsigned short int r = csr_readl(0xe00048c8);
	r <<= 8;
	r |= csr_readl(0xe00048cc);
	return r;
}
