...
/* gpio */
#define CSR_GPIO_BASE 0xe000a000
#define CSR_GPIO_CLK_A_N_ADDR 0xe000a000
#define CSR_GPIO_CLK_A_N_SIZE 1
static inline unsigned char gpio_clk_a_n_read(void) {
	unsigned char r = MMPTR(0xe000a000);
	return r;
}
static inline void gpio_clk_a_n_write(unsigned char value) {
	MMPTR(0xe000a000) = value;
}
#define CSR_GPIO_CLK_A_P_ADDR 0xe000a004
#define CSR_GPIO_CLK_A_P_SIZE 1
static inline unsigned char gpio_clk_a_p_read(void) {
	unsigned char r = MMPTR(0xe000a004);
	return r;
}
static inline void gpio_clk_a_p_write(unsigned char value) {
	MMPTR(0xe000a004) = value;
}
#define CSR_GPIO_IO_A_N_ADDR 0xe000a008
#define CSR_GPIO_IO_A_N_SIZE 1
static inline unsigned char gpio_io_a_n_read(void) {
	unsigned char r = MMPTR(0xe000a008);
	return r;
}
static inline void gpio_io_a_n_write(unsigned char value) {
	MMPTR(0xe000a008) = value;
}
#define CSR_GPIO_IO_A_P_ADDR 0xe000a00c
#define CSR_GPIO_IO_A_P_SIZE 1
static inline unsigned char gpio_io_a_p_read(void) {
	unsigned char r = MMPTR(0xe000a00c);
	return r;
}
static inline void gpio_io_a_p_write(unsigned char value) {
	MMPTR(0xe000a00c) = value;
}
#define CSR_GPIO_CLK_B_N_ADDR 0xe000a010
#define CSR_GPIO_CLK_B_N_SIZE 1
static inline unsigned char gpio_clk_b_n_read(void) {
	unsigned char r = MMPTR(0xe000a010);
	return r;
}
static inline void gpio_clk_b_n_write(unsigned char value) {
	MMPTR(0xe000a010) = value;
}
#define CSR_GPIO_CLK_B_P_ADDR 0xe000a014
#define CSR_GPIO_CLK_B_P_SIZE 1
static inline unsigned char gpio_clk_b_p_read(void) {
	unsigned char r = MMPTR(0xe000a014);
	return r;
}
static inline void gpio_clk_b_p_write(unsigned char value) {
	MMPTR(0xe000a014) = value;
}
#define CSR_GPIO_IO_B_N_ADDR 0xe000a018
#define CSR_GPIO_IO_B_N_SIZE 1
static inline unsigned char gpio_io_b_n_read(void) {
	unsigned char r = MMPTR(0xe000a018);
	return r;
}
static inline void gpio_io_b_n_write(unsigned char value) {
	MMPTR(0xe000a018) = value;
}
#define CSR_GPIO_IO_B_P_ADDR 0xe000a01c
#define CSR_GPIO_IO_B_P_SIZE 1
static inline unsigned char gpio_io_b_p_read(void) {
	unsigned char r = MMPTR(0xe000a01c);
	return r;
}
static inline void gpio_io_b_p_write(unsigned char value) {
	MMPTR(0xe000a01c) = value;
}
#define CSR_GPIO_CLK_X_N_ADDR 0xe000a020
#define CSR_GPIO_CLK_X_N_SIZE 1
static inline unsigned char gpio_clk_x_n_read(void) {
	unsigned char r = MMPTR(0xe000a020);
	return r;
}
static inline void gpio_clk_x_n_write(unsigned char value) {
	MMPTR(0xe000a020) = value;
}
#define CSR_GPIO_CLK_X_P_ADDR 0xe000a024
#define CSR_GPIO_CLK_X_P_SIZE 1
static inline unsigned char gpio_clk_x_p_read(void) {
	unsigned char r = MMPTR(0xe000a024);
	return r;
}
static inline void gpio_clk_x_p_write(unsigned char value) {
	MMPTR(0xe000a024) = value;
}
#define CSR_GPIO_IO_X_N_ADDR 0xe000a028
#define CSR_GPIO_IO_X_N_SIZE 1
static inline unsigned char gpio_io_x_n_read(void) {
	unsigned char r = MMPTR(0xe000a028);
	return r;
}
static inline void gpio_io_x_n_write(unsigned char value) {
	MMPTR(0xe000a028) = value;
}
#define CSR_GPIO_IO_X_P_ADDR 0xe000a02c
#define CSR_GPIO_IO_X_P_SIZE 1
static inline unsigned char gpio_io_x_p_read(void) {
	unsigned char r = MMPTR(0xe000a02c);
	return r;
}
static inline void gpio_io_x_p_write(unsigned char value) {
	MMPTR(0xe000a02c) = value;
}
...
/* tofe */
#define CSR_TOFE_BASE 0xe0008000
#define CSR_TOFE_I2C_W_ADDR 0xe0008000
#define CSR_TOFE_I2C_W_SIZE 1
static inline unsigned char tofe_i2c_w_read(void) {
	unsigned char r = MMPTR(0xe0008000);
	return r;
}
static inline void tofe_i2c_w_write(unsigned char value) {
	MMPTR(0xe0008000) = value;
}
#define CSR_TOFE_I2C_R_ADDR 0xe0008004
#define CSR_TOFE_I2C_R_SIZE 1
static inline unsigned char tofe_i2c_r_read(void) {
	unsigned char r = MMPTR(0xe0008004);
	return r;
}
#define CSR_TOFE_RST_OUT_ADDR 0xe0008008
#define CSR_TOFE_RST_OUT_SIZE 1
static inline unsigned char tofe_rst_out_read(void) {
	unsigned char r = MMPTR(0xe0008008);
	return r;
}
static inline void tofe_rst_out_write(unsigned char value) {
