//--------------------------------------------------------------------------------
// Auto-generated by Migen (562c046) & LiteX (113f7f40) on 2019-07-25 05:43:37
//--------------------------------------------------------------------------------
...
/* ethmac */
#define CSR_ETHMAC_BASE 0xe0007000L
#define CSR_ETHMAC_SRAM_WRITER_SLOT_ADDR 0xe0007000L
...
#define CSR_ETHMAC_SRAM_WRITER_LENGTH_ADDR 0xe0007004L
#define CSR_ETHMAC_SRAM_WRITER_LENGTH_SIZE 4
static inline unsigned int ethmac_sram_writer_length_read(void) {
	unsigned int r = csr_readl(0xe0007004L);
	r <<= 8;
	r |= csr_readl(0xe0007008L);
	r <<= 8;
...
#define CSR_ETHMAC_SRAM_WRITER_ERRORS_ADDR 0xe0007014L
#define CSR_ETHMAC_SRAM_WRITER_ERRORS_SIZE 4
static inline unsigned int ethmac_sram_writer_errors_read(void) {
	unsigned int r = csr_readl(0xe0007014L);
	r <<= 8;
	r |= csr_readl(0xe0007018L);
	r <<= 8;
	r |= csr_readl(0xe000701cL);
	r <<= 8;
	r |= csr_readl(0xe0007020L);
	return r;
}
#define CSR_ETHMAC_SRAM_WRITER_EV_STATUS_ADDR 0xe0007024L
...
static inline void ethmac_sram_writer_ev_status_write(unsigned char value) {
	csr_writel(value, 0xe0007024L);
}
#define CSR_ETHMAC_SRAM_WRITER_EV_PENDING_ADDR 0xe0007028L
...
#define CSR_ETHMAC_CRC_ERRORS_ADDR 0xe0007068L
#define CSR_ETHMAC_CRC_ERRORS_SIZE 4
static inline unsigned int ethmac_crc_errors_read(void) {
	unsigned int r = csr_readl(0xe0007068L);
	r <<= 8;
	r |= csr_readl(0xe000706cL);
	r <<= 8;
...
/* ethphy */
#define CSR_ETHPHY_BASE 0xe0006800L
#define CSR_ETHPHY_MODE_DETECTION_MODE_ADDR 0xe0006800L
...
#define CSR_ETHPHY_CRG_RESET_ADDR 0xe0006804L
...
#define CSR_ETHPHY_MDIO_W_ADDR 0xe0006808L
...
#define CSR_ETHPHY_MDIO_R_ADDR 0xe000680cL
