...
static inline unsigned long long int info_dna_id_read(void) {
	unsigned long long int r = MMPTR(0xe0004800);
	r <<= 8;
	r |= MMPTR(0xe0004804);
	r <<= 8;
	r |= MMPTR(0xe0004808);
...
static inline unsigned long long int info_platform_platform_read(void) {
	unsigned long long int r = MMPTR(0xe0004870);
	r <<= 8;
	r |= MMPTR(0xe0004874);
	r <<= 8;
	r |= MMPTR(0xe0004878);
...
static inline unsigned long long int info_platform_target_read(void) {
	unsigned long long int r = MMPTR(0xe0004890);
	r <<= 8;
	r |= MMPTR(0xe0004894);
	r <<= 8;
	r |= MMPTR(0xe0004898);
...
static inline unsigned short int info_xadc_temperature_read(void) {
	unsigned short int r = MMPTR(0xe00048b0);
	r <<= 8;
	r |= MMPTR(0xe00048b4);
	return r;
}
...
static inline unsigned short int info_xadc_vccint_read(void) {
	unsigned short int r = MMPTR(0xe00048b8);
	r <<= 8;
	r |= MMPTR(0xe00048bc);
	return r;
}
...
static inline unsigned short int info_xadc_vccaux_read(void) {
	unsigned short int r = MMPTR(0xe00048c0);
	r <<= 8;
	r |= MMPTR(0xe00048c4);
	return r;
}
...
static inline unsigned short int info_xadc_vccbram_read(void) {
	unsigned short int r = MMPTR(0xe00048c8);
	r <<= 8;
	r |= MMPTR(0xe00048cc);
	return r;
}
