...
/* ddrphy */
#define CSR_DDRPHY_BASE 0xe0005000L
#define CSR_DDRPHY_HALF_SYS8X_TAPS_ADDR 0xe0005000L
...
#define CSR_DDRPHY_CDLY_RST_ADDR 0xe0005004L
...
#define CSR_DDRPHY_CDLY_INC_ADDR 0xe0005008L
...
#define CSR_DDRPHY_DLY_SEL_ADDR 0xe000500cL
...
#define CSR_DDRPHY_RDLY_DQ_RST_ADDR 0xe0005010L
...
static inline void ddrphy_rdly_dq_rst_write(unsigned char value) {
	csr_writel(value, 0xe0005010L);
}
#define CSR_DDRPHY_RDLY_DQ_INC_ADDR 0xe0005014L
...
static inline void ddrphy_rdly_dq_inc_write(unsigned char value) {
	csr_writel(value, 0xe0005014L);
}
#define CSR_DDRPHY_RDLY_DQ_BITSLIP_RST_ADDR 0xe0005018L
...
static inline void ddrphy_rdly_dq_bitslip_rst_write(unsigned char value) {
	csr_writel(value, 0xe0005018L);
}
#define CSR_DDRPHY_RDLY_DQ_BITSLIP_ADDR 0xe000501cL
...
#define CSR_INFO_XADC_TEMPERATURE_ADDR 0xe00068b0L
...
#define CSR_INFO_XADC_VCCINT_ADDR 0xe00068b8L
#define CSR_INFO_XADC_VCCINT_SIZE 2
static inline unsigned short int info_xadc_vccint_read(void) {
	unsigned short int r = csr_readl(0xe00068b8L);
	r <<= 8;
	r |= csr_readl(0xe00068bcL);
	return r;
}
#define CSR_INFO_XADC_VCCAUX_ADDR 0xe00068c0L
#define CSR_INFO_XADC_VCCAUX_SIZE 2
static inline unsigned short int info_xadc_vccaux_read(void) {
	unsigned short int r = csr_readl(0xe00068c0L);
	r <<= 8;
	r |= csr_readl(0xe00068c4L);
	return r;
}
#define CSR_INFO_XADC_VCCBRAM_ADDR 0xe00068c8L
#define CSR_INFO_XADC_VCCBRAM_SIZE 2
static inline unsigned short int info_xadc_vccbram_read(void) {
	unsigned short int r = csr_readl(0xe00068c8L);
	r <<= 8;
	r |= csr_readl(0xe00068ccL);
	return r;
}
...
static inline unsigned long long int sdram_dfii_pi0_wrdata_read(void) {
	unsigned long long int r = csr_readl(0xe0004018L);
	r <<= 8;
...
static inline void sdram_dfii_pi0_wrdata_write(unsigned long long int value) {
	csr_writel(value >> 56, 0xe0004018L);
	csr_writel(value >> 48, 0xe000401cL);
	csr_writel(value >> 40, 0xe0004020L);
	csr_writel(value >> 32, 0xe0004024L);
	csr_writel(value >> 24, 0xe0004028L);
	csr_writel(value >> 16, 0xe000402cL);
	csr_writel(value >> 8, 0xe0004030L);
	csr_writel(value, 0xe0004034L);
}
#define CSR_SDRAM_DFII_PI0_RDDATA_ADDR 0xe0004038L
#define CSR_SDRAM_DFII_PI0_RDDATA_SIZE 8
static inline unsigned long long int sdram_dfii_pi0_rddata_read(void) {
	unsigned long long int r = csr_readl(0xe0004038L);
	r <<= 8;
	r |= csr_readl(0xe000403cL);
	r <<= 8;
	r |= csr_readl(0xe0004040L);
	r <<= 8;
	r |= csr_readl(0xe0004044L);
	r <<= 8;
	r |= csr_readl(0xe0004048L);
	r <<= 8;
	r |= csr_readl(0xe000404cL);
	r <<= 8;
...
static inline void sdram_dfii_pi1_wrdata_write(unsigned long long int value) {
	csr_writel(value >> 56, 0xe000406cL);
	csr_writel(value >> 48, 0xe0004070L);
	csr_writel(value >> 40, 0xe0004074L);
	csr_writel(value >> 32, 0xe0004078L);
	csr_writel(value >> 24, 0xe000407cL);
	csr_writel(value >> 16, 0xe0004080L);
	csr_writel(value >> 8, 0xe0004084L);
	csr_writel(value, 0xe0004088L);
}
#define CSR_SDRAM_DFII_PI1_RDDATA_ADDR 0xe000408cL
#define CSR_SDRAM_DFII_PI1_RDDATA_SIZE 8
static inline unsigned long long int sdram_dfii_pi1_rddata_read(void) {
	unsigned long long int r = csr_readl(0xe000408cL);
	r <<= 8;
	r |= csr_readl(0xe0004090L);
	r <<= 8;
	...
	r <<= 8;
	r |= csr_readl(0xe00040a0L);
	r <<= 8;
	r |= csr_readl(0xe00040a4L);
	r <<= 8;
	r |= csr_readl(0xe00040a8L);
	return r;
}
#define CSR_SDRAM_DFII_PI2_COMMAND_ADDR 0xe00040acL
#define CSR_SDRAM_DFII_PI2_COMMAND_SIZE 1
static inline unsigned char sdram_dfii_pi2_command_read(void) {
	unsigned char r = csr_readl(0xe00040acL);
	return r;
}
static inline void sdram_dfii_pi2_command_write(unsigned char value) {
	csr_writel(value, 0xe00040acL);
}
#define CSR_SDRAM_DFII_PI2_COMMAND_ISSUE_ADDR 0xe00040b0L
...
static inline unsigned long long int sdram_dfii_pi2_wrdata_read(void) {
	...
	r <<= 8;
	r |= csr_readl(0xe00040d4L);
	r <<= 8;
	r |= csr_readl(0xe00040d8L);
	r <<= 8;
	r |= csr_readl(0xe00040dcL);
	return r;
}
static inline void sdram_dfii_pi2_wrdata_write(unsigned long long int value) {
	csr_writel(value >> 56, 0xe00040c0L);
	csr_writel(value >> 48, 0xe00040c4L);
	csr_writel(value >> 40, 0xe00040c8L);
	csr_writel(value >> 32, 0xe00040ccL);
	csr_writel(value >> 24, 0xe00040d0L);
	csr_writel(value >> 16, 0xe00040d4L);
	csr_writel(value >> 8, 0xe00040d8L);
	csr_writel(value, 0xe00040dcL);
}
#define CSR_SDRAM_DFII_PI2_RDDATA_ADDR 0xe00040e0L
#define CSR_SDRAM_DFII_PI2_RDDATA_SIZE 8
static inline unsigned long long int sdram_dfii_pi2_rddata_read(void) {
	unsigned long long int r = csr_readl(0xe00040e0L);
	r <<= 8;
	r |= csr_readl(0xe00040e4L);
	r <<= 8;
	r |= csr_readl(0xe00040e8L);
	r <<= 8;
	r |= csr_readl(0xe00040ecL);
	r <<= 8;
	r |= csr_readl(0xe00040f0L);
	r <<= 8;
	r |= csr_readl(0xe00040f4L);
	r <<= 8;
	r |= csr_readl(0xe00040f8L);
	r <<= 8;
	r |= csr_readl(0xe00040fcL);
	return r;
}
#define CSR_SDRAM_DFII_PI3_COMMAND_ADDR 0xe0004100L
#define CSR_SDRAM_DFII_PI3_COMMAND_SIZE 1
static inline unsigned char sdram_dfii_pi3_command_read(void) {
	unsigned char r = csr_readl(0xe0004100L);
	return r;
}
static inline void sdram_dfii_pi3_command_write(unsigned char value) {
	csr_writel(value, 0xe0004100L);
}
#define CSR_SDRAM_DFII_PI3_COMMAND_ISSUE_ADDR 0xe0004104L
#define CSR_SDRAM_DFII_PI3_COMMAND_ISSUE_SIZE 1
static inline unsigned char sdram_dfii_pi3_command_issue_read(void) {
	unsigned char r = csr_readl(0xe0004104L);
	return r;
}
static inline void sdram_dfii_pi3_command_issue_write(unsigned char value) {
	csr_writel(value, 0xe0004104L);
}
#define CSR_SDRAM_DFII_PI3_ADDRESS_ADDR 0xe0004108L
#define CSR_SDRAM_DFII_PI3_ADDRESS_SIZE 2
static inline unsigned short int sdram_dfii_pi3_address_read(void) {
	unsigned short int r = csr_readl(0xe0004108L);
	r <<= 8;
	r |= csr_readl(0xe000410cL);
	return r;
}
static inline void sdram_dfii_pi3_address_write(unsigned short int value) {
	csr_writel(value >> 8, 0xe0004108L);
	csr_writel(value, 0xe000410cL);
}
#define CSR_SDRAM_DFII_PI3_BADDRESS_ADDR 0xe0004110L
#define CSR_SDRAM_DFII_PI3_BADDRESS_SIZE 1
static inline unsigned char sdram_dfii_pi3_baddress_read(void) {
	unsigned char r = csr_readl(0xe0004110L);
	return r;
}
static inline void sdram_dfii_pi3_baddress_write(unsigned char value) {
	csr_writel(value, 0xe0004110L);
}
#define CSR_SDRAM_DFII_PI3_WRDATA_ADDR 0xe0004114L
#define CSR_SDRAM_DFII_PI3_WRDATA_SIZE 8
static inline unsigned long long int sdram_dfii_pi3_wrdata_read(void) {
	unsigned long long int r = csr_readl(0xe0004114L);
	r <<= 8;
	r |= csr_readl(0xe0004118L);
	r <<= 8;
	r |= csr_readl(0xe000411cL);
	r <<= 8;
	r |= csr_readl(0xe0004120L);
	r <<= 8;
	r |= csr_readl(0xe0004124L);
	r <<= 8;
	r |= csr_readl(0xe0004128L);
	r <<= 8;
	r |= csr_readl(0xe000412cL);
	r <<= 8;
	r |= csr_readl(0xe0004130L);
	return r;
}
static inline void sdram_dfii_pi3_wrdata_write(unsigned long long int value) {
	csr_writel(value >> 56, 0xe0004114L);
	csr_writel(value >> 48, 0xe0004118L);
	csr_writel(value >> 40, 0xe000411cL);
	csr_writel(value >> 32, 0xe0004120L);
	csr_writel(value >> 24, 0xe0004124L);
	csr_writel(value >> 16, 0xe0004128L);
	csr_writel(value >> 8, 0xe000412cL);
	csr_writel(value, 0xe0004130L);
}
#define CSR_SDRAM_DFII_PI3_RDDATA_ADDR 0xe0004134L
#define CSR_SDRAM_DFII_PI3_RDDATA_SIZE 8
static inline unsigned long long int sdram_dfii_pi3_rddata_read(void) {
	unsigned long long int r = csr_readl(0xe0004134L);
	r <<= 8;
	r |= csr_readl(0xe0004138L);
	r <<= 8;
	r |= csr_readl(0xe000413cL);
	r <<= 8;
	r |= csr_readl(0xe0004140L);
	r <<= 8;
	r |= csr_readl(0xe0004144L);
	r <<= 8;
	r |= csr_readl(0xe0004148L);
	r <<= 8;
	r |= csr_readl(0xe000414cL);
	r <<= 8;
	r |= csr_readl(0xe0004150L);
	return r;
}
#define CSR_SDRAM_CONTROLLER_BANDWIDTH_UPDATE_ADDR 0xe0004154L
...
static inline unsigned char sdram_controller_bandwidth_update_read(void) {
	unsigned char r = csr_readl(0xe0004154L);
	return r;
}
static inline void sdram_controller_bandwidth_update_write(unsigned char value) {
	csr_writel(value, 0xe0004154L);
}
#define CSR_SDRAM_CONTROLLER_BANDWIDTH_NREADS_ADDR 0xe0004158L
...
static inline unsigned int sdram_controller_bandwidth_nreads_read(void) {
	unsigned int r = csr_readl(0xe0004158L);
	r <<= 8;
	r |= csr_readl(0xe000415cL);
	r <<= 8;
	r |= csr_readl(0xe0004160L);
	return r;
}
#define CSR_SDRAM_CONTROLLER_BANDWIDTH_NWRITES_ADDR 0xe0004164L
...
static inline unsigned int sdram_controller_bandwidth_nwrites_read(void) {
	unsigned int r = csr_readl(0xe0004164L);
	r <<= 8;
	r |= csr_readl(0xe0004168L);
	r <<= 8;
	r |= csr_readl(0xe000416cL);
	return r;
}
#define CSR_SDRAM_CONTROLLER_BANDWIDTH_DATA_WIDTH_ADDR 0xe0004170L
...
static inline unsigned short int sdram_controller_bandwidth_data_width_read(void) {
	unsigned short int r = csr_readl(0xe0004170L);
	r <<= 8;
	r |= csr_readl(0xe0004174L);
	return r;
}
