create_project -force -name top -part xc7a50t-csg325-2
...
read_xdc top.xdc
synth_design -top top -part xc7a50t-csg325-2 -include_dirs {/home/travis/build/timvideos/HDMI2USB-litex-firmware/third_party/litex/litex/soc/cores/cpu/lm32/verilog/config /home/travis/build/timvideos/HDMI2USB-litex-firmware/third_party/litex/litex/soc/cores/cpu/lm32/verilog/submodule/rtl}
...
write_cfgmem -verbose -force -format bin -interface spix1 -size 64 -loadbit "up 0x0 top.bit" -file top.bin
quit