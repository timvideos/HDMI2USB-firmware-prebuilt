...
set_property IOSTANDARD LVCMOS25 [get_ports eth_tx_data[3]]
 ## hdmi_in:0.clk_p
set_property LOC V4 [get_ports hdmi_in_clk_p]
set_property IOSTANDARD TMDS_33 [get_ports hdmi_in_clk_p]
 ## hdmi_in:0.clk_n
set_property LOC W4 [get_ports hdmi_in_clk_n]
set_property IOSTANDARD TMDS_33 [get_ports hdmi_in_clk_n]
 ## hdmi_in:0.data0_p
set_property LOC Y3 [get_ports hdmi_in_data0_p]
set_property IOSTANDARD TMDS_33 [get_ports hdmi_in_data0_p]
 ## hdmi_in:0.data0_n
set_property LOC AA3 [get_ports hdmi_in_data0_n]
set_property IOSTANDARD TMDS_33 [get_ports hdmi_in_data0_n]
 ## hdmi_in:0.data1_p
set_property LOC W2 [get_ports hdmi_in_data1_p]
set_property IOSTANDARD TMDS_33 [get_ports hdmi_in_data1_p]
 ## hdmi_in:0.data1_n
set_property LOC Y2 [get_ports hdmi_in_data1_n]
set_property IOSTANDARD TMDS_33 [get_ports hdmi_in_data1_n]
 ## hdmi_in:0.data2_p
set_property LOC U2 [get_ports hdmi_in_data2_p]
set_property IOSTANDARD TMDS_33 [get_ports hdmi_in_data2_p]
 ## hdmi_in:0.data2_n
set_property LOC V2 [get_ports hdmi_in_data2_n]
set_property IOSTANDARD TMDS_33 [get_ports hdmi_in_data2_n]
 ## hdmi_in:0.scl
set_property LOC Y4 [get_ports hdmi_in_scl]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_in_scl]
 ## hdmi_in:0.sda
set_property LOC AB5 [get_ports hdmi_in_sda]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_in_sda]
 ## hdmi_in:0.hpd_en
set_property LOC AB12 [get_ports hdmi_in_hpd_en]
set_property IOSTANDARD LVCMOS25 [get_ports hdmi_in_hpd_en]
 ## hdmi_in:0.cec
set_property LOC AA5 [get_ports hdmi_in_cec]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_in_cec]
 ## hdmi_in:0.txen
set_property LOC R3 [get_ports hdmi_in_txen]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_in_txen]
 ## hdmi_out:0.clk_p
...
create_clock -name hdmi_in0_pix_clk -period 6.734006734006734 [get_nets hdmi_in0_pix_clk]

create_clock -name pix1p25x_clk -period 5.3872053872053876 [get_nets pix1p25x_clk]

create_clock -name hdmi_in0_pix5x_clk -period 1.3468013468013469 [get_nets hdmi_in0_pix5x_clk]

create_clock -name hdmi_out0_pix_clk -period 6.734006734006734 [get_nets hdmi_out0_pix_clk]

create_clock -name hdmi_out0_pix5x_clk -period 1.3468013468013469 [get_nets hdmi_out0_pix5x_clk]

set_false_path -from [get_clocks sys_clk] -to [get_clocks eth_rx_clk]

set_false_path -from [get_clocks sys_clk] -to [get_clocks eth_tx_clk]

set_false_path -from [get_clocks sys_clk] -to [get_clocks hdmi_in0_pix_clk]

set_false_path -from [get_clocks sys_clk] -to [get_clocks pix1p25x_clk]

set_false_path -from [get_clocks sys_clk] -to [get_clocks hdmi_in0_pix5x_clk]

set_false_path -from [get_clocks sys_clk] -to [get_clocks hdmi_out0_pix_clk]

set_false_path -from [get_clocks sys_clk] -to [get_clocks hdmi_out0_pix5x_clk]
...
set_false_path -from [get_clocks hdmi_in0_pix_clk] -to [get_clocks sys_clk]

set_false_path -from [get_clocks hdmi_in0_pix_clk] -to [get_clocks pix1p25x_clk]

set_false_path -from [get_clocks hdmi_in0_pix_clk] -to [get_clocks hdmi_in0_pix5x_clk]

set_false_path -from [get_clocks pix1p25x_clk] -to [get_clocks sys_clk]

set_false_path -from [get_clocks pix1p25x_clk] -to [get_clocks hdmi_in0_pix_clk]

set_false_path -from [get_clocks pix1p25x_clk] -to [get_clocks hdmi_in0_pix5x_clk]

set_false_path -from [get_clocks hdmi_in0_pix5x_clk] -to [get_clocks sys_clk]

set_false_path -from [get_clocks hdmi_in0_pix5x_clk] -to [get_clocks hdmi_in0_pix_clk]

set_false_path -from [get_clocks hdmi_in0_pix5x_clk] -to [get_clocks pix1p25x_clk]

set_false_path -from [get_clocks hdmi_out0_pix_clk] -to [get_clocks sys_clk]

set_false_path -from [get_clocks hdmi_out0_pix_clk] -to [get_clocks hdmi_out0_pix5x_clk]

set_false_path -from [get_clocks hdmi_out0_pix5x_clk] -to [get_clocks sys_clk]

set_false_path -from [get_clocks hdmi_out0_pix5x_clk] -to [get_clocks hdmi_out0_pix_clk]
