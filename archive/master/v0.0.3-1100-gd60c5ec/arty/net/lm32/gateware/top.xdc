...
set_property IOSTANDARD LVCMOS33 [get_ports rgb_leds_r[0]]
 ## rgb_leds:0.r
set_property LOC G3 [get_ports rgb_leds_r[1]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb_leds_r[1]]
 ## rgb_leds:0.r
set_property LOC J3 [get_ports rgb_leds_r[2]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb_leds_r[2]]
 ## rgb_leds:0.r
set_property LOC K1 [get_ports rgb_leds_r[3]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb_leds_r[3]]
 ## rgb_leds:0.g
set_property LOC F6 [get_ports rgb_leds_g[0]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb_leds_g[0]]
 ## rgb_leds:0.g
set_property LOC J4 [get_ports rgb_leds_g[1]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb_leds_g[1]]
 ## rgb_leds:0.g
set_property LOC J2 [get_ports rgb_leds_g[2]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb_leds_g[2]]
 ## rgb_leds:0.g
set_property LOC H6 [get_ports rgb_leds_g[3]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb_leds_g[3]]
 ## rgb_leds:0.b
set_property LOC E1 [get_ports rgb_leds_b[0]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb_leds_b[0]]
 ## rgb_leds:0.b
set_property LOC G4 [get_ports rgb_leds_b[1]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb_leds_b[1]]
 ## rgb_leds:0.b
set_property LOC H4 [get_ports rgb_leds_b[2]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb_leds_b[2]]
 ## rgb_leds:0.b
set_property LOC K2 [get_ports rgb_leds_b[3]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb_leds_b[3]]
 ## spiflash_1x:0.cs_n
...
set_property IOSTANDARD LVCMOS33 [get_ports eth_mdc]
 ## eth:0.dv
set_property LOC G16 [get_ports eth_dv]
set_property IOSTANDARD LVCMOS33 [get_ports eth_dv]
 ## eth:0.rx_er
