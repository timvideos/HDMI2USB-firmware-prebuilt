...
static inline unsigned short int hdmi_out0_core_initiator_hsync_start_read(void) {
	unsigned short int r = MMPTR(0xe000d024);
	r <<= 8;
	r |= MMPTR(0xe000d028);
	return r;
}
static inline void hdmi_out0_core_initiator_hsync_start_write(unsigned short int value) {
	MMPTR(0xe000d024) = value >> 8;
	MMPTR(0xe000d028) = value;
}
#define CSR_HDMI_OUT0_CORE_INITIATOR_HSYNC_END_ADDR 0xe000d02c
...
static inline unsigned short int hdmi_out0_core_initiator_hsync_end_read(void) {
	unsigned short int r = MMPTR(0xe000d02c);
	r <<= 8;
	r |= MMPTR(0xe000d030);
	return r;
}
static inline void hdmi_out0_core_initiator_hsync_end_write(unsigned short int value) {
	MMPTR(0xe000d02c) = value >> 8;
	MMPTR(0xe000d030) = value;
}
#define CSR_HDMI_OUT0_CORE_INITIATOR_HSCAN_ADDR 0xe000d034
...
static inline unsigned short int hdmi_out0_core_initiator_hscan_read(void) {
	unsigned short int r = MMPTR(0xe000d034);
	r <<= 8;
	r |= MMPTR(0xe000d038);
	return r;
}
static inline void hdmi_out0_core_initiator_hscan_write(unsigned short int value) {
	MMPTR(0xe000d034) = value >> 8;
	MMPTR(0xe000d038) = value;
}
#define CSR_HDMI_OUT0_CORE_INITIATOR_VRES_ADDR 0xe000d03c
#define CSR_HDMI_OUT0_CORE_INITIATOR_VRES_SIZE 2
static inline unsigned short int hdmi_out0_core_initiator_vres_read(void) {
	unsigned short int r = MMPTR(0xe000d03c);
	r <<= 8;
	r |= MMPTR(0xe000d040);
	return r;
}
static inline void hdmi_out0_core_initiator_vres_write(unsigned short int value) {
	MMPTR(0xe000d03c) = value >> 8;
	MMPTR(0xe000d040) = value;
}
#define CSR_HDMI_OUT0_CORE_INITIATOR_VSYNC_START_ADDR 0xe000d044
...
static inline unsigned short int hdmi_out0_core_initiator_vsync_start_read(void) {
	unsigned short int r = MMPTR(0xe000d044);
	r <<= 8;
	r |= MMPTR(0xe000d048);
	return r;
}
static inline void hdmi_out0_core_initiator_vsync_start_write(unsigned short int value) {
	MMPTR(0xe000d044) = value >> 8;
	MMPTR(0xe000d048) = value;
}
#define CSR_HDMI_OUT0_CORE_INITIATOR_VSYNC_END_ADDR 0xe000d04c
...
static inline unsigned short int hdmi_out0_core_initiator_vsync_end_read(void) {
	unsigned short int r = MMPTR(0xe000d04c);
	r <<= 8;
	r |= MMPTR(0xe000d050);
	return r;
}
static inline void hdmi_out0_core_initiator_vsync_end_write(unsigned short int value) {
	MMPTR(0xe000d04c) = value >> 8;
	MMPTR(0xe000d050) = value;
}
#define CSR_HDMI_OUT0_CORE_INITIATOR_VSCAN_ADDR 0xe000d054
...
static inline void hdmi_out0_core_initiator_base_write(unsigned int value) {
	MMPTR(0xe000d05c) = value >> 24;
	MMPTR(0xe000d060) = value >> 16;
	MMPTR(0xe000d064) = value >> 8;
	MMPTR(0xe000d068) = value;
}
#define CSR_HDMI_OUT0_CORE_INITIATOR_LENGTH_ADDR 0xe000d06c
#define CSR_HDMI_OUT0_CORE_INITIATOR_LENGTH_SIZE 4
static inline unsigned int hdmi_out0_core_initiator_length_read(void) {
	unsigned int r = MMPTR(0xe000d06c);
	r <<= 8;
	r |= MMPTR(0xe000d070);
	r <<= 8;
	r |= MMPTR(0xe000d074);
...
static inline void hdmi_out0_core_initiator_length_write(unsigned int value) {
	MMPTR(0xe000d06c) = value >> 24;
	MMPTR(0xe000d070) = value >> 16;
	MMPTR(0xe000d074) = value >> 8;
	MMPTR(0xe000d078) = value;
}
#define CSR_HDMI_OUT0_DRIVER_CLOCKING_MMCM_RESET_ADDR 0xe000d07c
...
static inline unsigned char hdmi_out0_driver_clocking_mmcm_reset_read(void) {
	unsigned char r = MMPTR(0xe000d07c);
	return r;
}
static inline void hdmi_out0_driver_clocking_mmcm_reset_write(unsigned char value) {
	MMPTR(0xe000d07c) = value;
}
#define CSR_HDMI_OUT0_DRIVER_CLOCKING_MMCM_READ_ADDR 0xe000d080
...
static inline unsigned char hdmi_out0_driver_clocking_mmcm_read_read(void) {
	unsigned char r = MMPTR(0xe000d080);
	return r;
}
static inline void hdmi_out0_driver_clocking_mmcm_read_write(unsigned char value) {
	MMPTR(0xe000d080) = value;
}
#define CSR_HDMI_OUT0_DRIVER_CLOCKING_MMCM_WRITE_ADDR 0xe000d084
...
static inline unsigned char hdmi_out0_driver_clocking_mmcm_write_read(void) {
	unsigned char r = MMPTR(0xe000d084);
	return r;
}
static inline void hdmi_out0_driver_clocking_mmcm_write_write(unsigned char value) {
	MMPTR(0xe000d084) = value;
}
#define CSR_HDMI_OUT0_DRIVER_CLOCKING_MMCM_DRDY_ADDR 0xe000d088
...
static inline unsigned char hdmi_out0_driver_clocking_mmcm_drdy_read(void) {
	unsigned char r = MMPTR(0xe000d088);
	return r;
}
#define CSR_HDMI_OUT0_DRIVER_CLOCKING_MMCM_ADR_ADDR 0xe000d08c
...
static inline unsigned char hdmi_out0_driver_clocking_mmcm_adr_read(void) {
	unsigned char r = MMPTR(0xe000d08c);
	return r;
}
static inline void hdmi_out0_driver_clocking_mmcm_adr_write(unsigned char value) {
	MMPTR(0xe000d08c) = value;
}
#define CSR_HDMI_OUT0_DRIVER_CLOCKING_MMCM_DAT_W_ADDR 0xe000d090
...
static inline unsigned short int hdmi_out0_driver_clocking_mmcm_dat_w_read(void) {
	unsigned short int r = MMPTR(0xe000d090);
	r <<= 8;
	r |= MMPTR(0xe000d094);
	return r;
}
static inline void hdmi_out0_driver_clocking_mmcm_dat_w_write(unsigned short int value) {
	MMPTR(0xe000d090) = value >> 8;
	MMPTR(0xe000d094) = value;
}
#define CSR_HDMI_OUT0_DRIVER_CLOCKING_MMCM_DAT_R_ADDR 0xe000d098
...
static inline unsigned short int hdmi_out0_driver_clocking_mmcm_dat_r_read(void) {
	unsigned short int r = MMPTR(0xe000d098);
	r <<= 8;
	r |= MMPTR(0xe000d09c);
	return r;
}
...
#define HDMI_IN0_DESCRIPTION "  FIXME in platforms/netv2.py\r\n"
static inline const char * hdmi_in0_description_read(void) {
	return "  FIXME in platforms/netv2.py\r\n";
}
#define HDMI_IN0_MNEMONIC "RX1"
static inline const char * hdmi_in0_mnemonic_read(void) {
	return "RX1";
}
#define HDMI_OUT0_DESCRIPTION "  FIXME in platforms/netv2.py\r\n"
